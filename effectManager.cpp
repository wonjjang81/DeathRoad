...
void effectManager::addEffect(string effectName, const char* imageName, LPCWSTR fileName, int imageWidth, int imageHeight, int effectWidth, int effectHeight, int fps, float elapsedTime, int buffer)
{
	image* img;
