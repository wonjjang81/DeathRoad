...
void mapTool::btnSetup()
{
	...
	_btnA_unMove->init("맵툴버튼타이틀탭",  L"EP", 10, imgReX + (_btnImgReWidth * 1), imgReY - (_btnImgReHeight), PointMake(1, 6), PointMake(0, 6), _btnScale);
	_btnA_ARender = new fButton;
	_btnA_ARender->init("맵툴버튼타이틀탭", L"ID", 10, imgReX + (_btnImgReWidth * 2), imgReY - (_btnImgReHeight), PointMake(1, 6), PointMake(0, 6), _btnScale);
